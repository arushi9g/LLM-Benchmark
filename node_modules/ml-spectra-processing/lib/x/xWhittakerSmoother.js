...
exports.xWhitakerSmoother = void 0;
exports.xWhittakerSmoother = xWhittakerSmoother;
...
function xWhittakerSmoother(yData, options = {}) {
    ...
    let iteration = 0;
    let delta = Infinity;
    let baseline = (0, xEnsureFloat64_1.xEnsureFloat64)(yData);
 ...
 */
exports.xWhitakerSmoother = xWhittakerSmoother;
